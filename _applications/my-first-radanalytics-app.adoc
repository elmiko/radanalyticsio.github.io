...
This tutorial will walk you through every step to creating, deploying and operating an Apache Spark driver application on OpenShift. You should expect to spend 30 to 60 minutes on these exercises, depending on your familiarity.
...
* link:/assets/my-first-radanalytics-app/my-first-radanalytics-app-python.html[Python with Flask]
